...
class CronTask extends CommonDBTM{
   ...
   **/
    ...
    *    2: execution prevented by maintenance mode
    *    3: unable to run on slave DB
    *    4: unable to get DB lock
    *    5: locked by global lock file
    *    6: locked by self lock file
    *    7: no callable function associated to task
    *
